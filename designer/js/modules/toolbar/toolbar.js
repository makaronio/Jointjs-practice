...
define("toolbar", [
    ...
    ToolbarView = Backbone.View.extend({
        ...
        onExportClick: function() {
            ...
            require(['exportJson'], function(exportJson) {
                exportJson.getJson(function(cfdConfig, webitelConfig) {
                    localStorage.setItem("exportedSchema", cfdConfig);
                    alert("Schema has been exported");
                });
            });
        },
        ...
        onImportClick: function() {
            ...
            var schemaImport = localStorage.getItem("exportedSchema");

            require(['importJson'], function(importJson) {
                importJson.loadJson(schemaImport, {}, false);
            });
        },
