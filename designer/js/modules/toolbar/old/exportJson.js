    ...
    */
    ...
    return {
        ...
        getAnswerProperty: function(cell) {
            ...
            var value = (config.properties && config.properties.status && config.properties.status.value) || "";
        ...
        getSetVarProperty: function(cell) {
            ...
            var value = (config.properties && config.properties.variables && config.properties.variables.value) || "";
        ...
        getRecordSessionProperty: function(cell) {
            ...
            var value = (config.properties && config.properties.record && config.properties.record.value) || "";
        ...
        getSleepProperty: function(cell) {
            ...
            var value = (config.properties && config.properties.time && config.properties.time.value) || "";
